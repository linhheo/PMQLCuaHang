...
namespace BOHOPUB2HAND.Controllers
{
    public class NhacungcapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NhaCungCapID,TenNhaCungCap,DiaChỉ,SoDienThoai,Email")] Nhacungcap nhacungcap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NhaCungCapID,TenNhaCungCap,DiaChỉ,SoDienThoai,Email")] Nhacungcap nhacungcap)
        {
            if (ModelState.IsValid)
            {
